...
st.info("""
    **Síntese Executiva:** 
    Com 95,24% das unidades da Companhia avaliadas e 205 atribuições mapeadas, a aderência geral (A1 Conforme/A2 Forma distinta) da companhia é de **65,9%** (149 atribuições). 
